...
call "%%CONTOOLS_ROOT%%/scm/svn/gen_branch_workingset.bat" %%3 %%4 %%5 %%6 %%7 %%8 %%9 "%%~1" "%%~2_root_info.txt" "%%~2_root_changeset.lst" "%%~2_root_diff.patch" "%%~2_root_externals.lst" "%%~2_workingset.lst" "%%~2_workingset" "%%~2_root_files.lst" "%%~2_all_files.lst" "%%~2_all_files_hash.lst" "%%~2_root_status.txt" "%%~2_all_status.txt"
